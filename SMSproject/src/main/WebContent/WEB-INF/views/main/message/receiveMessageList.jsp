...
<div class="col-lg-6 col-lg-offset-3">
	<div class="row">
		<form id="searchForm" class="form-horizontal pull-right" action="${contextPath }/message/receiveMessageList" method="get">
			<div class="row">
	...
	<div class="row">
		<ul class="nav nav-tabs col-xs-11">
			<li class="active"><a href="${contextPath }/message/receiveMessageList">받은 메시지함</a></li>
		    <li><a href="${contextPath }/message/sendMessageList">보낸 메시지함</a></li>
  		</ul>
	</div>
	<c:choose>
			...
			<div class="row">
				<div class="panel-group message-div" id="accordion" role="tablist">
					<div class="panel panel-default">
						<div class="row">
							<div class="col-xs-5 th text-center">보낸 직원</div>
					...
					<c:forEach var="message" items="${pageInfo.dataList}" varStatus="vs">
						<div class="panel panel-default">
							<div class="row">
								<div class="col-xs-5 td text-center">${message.sender.empName }(${message.sender.email })</div>
