...
<div class="row">
	...
	<c:choose>
			<c:when test="${clientUpdateInfo == null}">
				거래처가 존재하지 않습니다.
			</c:when>
			<c:otherwise>
				<div class="row">
					<form id="clientForm" class="form-horizontal" action="${contextPath }/rest/client/updateClient" method="post">
							<div class="form-group">
								<label for="clientCode" class="col-xs-3 col-xs-offset-1 control-label">고객코드</label>
								<div class="col-xs-6">
									<input type="text" class="form-control" id="clientCode" name="clientCode" value="${clientUpdateInfo.clientCode}" readonly/>
								</div>
							</div>
							<div class="form-group">
								<label for="clientName" class="col-xs-3 col-xs-offset-1 control-label">고객명</label>
								<div class="col-xs-6">
									<input type="text" class="form-control" id="clientName" name="clientName" value="${clientUpdateInfo.clientName}"/>
								</div>
							</div>
							<div class="form-group">
								<label for="ceo" class="col-xs-3 col-xs-offset-1 control-label">대표자</label>
								<div class="col-xs-6">
									<input type="text" class="form-control" id="ceo" name="ceo" value="${clientUpdateInfo.ceo}"/>
								</div>
							</div>
							<div class="form-group">
								<label for="secondName" class="col-xs-3 col-xs-offset-1 control-label">2차거래선</label>
								<div class="col-xs-6">
									<input type="text" class="form-control" id="secondName" name="secondName" value="${clientUpdateInfo.secondName}"/>
								</div>
							</div>
							<div class="form-group">
								<label for="phone1" class="col-xs-3 col-xs-offset-1 control-label">연락처</label>
								<div class="col-xs-2">
									<input type="text" class="form-control input-sm" id="phone1" name="phone1" value="${clientUpdateInfo.phone1}"/>
								</div>
								<div class="col-xs-2">
									<input type="text" class="form-control input-sm" id="phone2" name="phone2" value="${clientUpdateInfo.phone2}"/>
								</div>
								<div class="col-xs-2">
									<input type="text" class="form-control input-sm" id="phone3" name="phone3" value="${clientUpdateInfo.phone3}"/>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-5">
									<input type="text" class="form-control" id="address" name="address" value="${clientUpdateInfo.address}" readonly="readonly"/>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-2">
									<input id="cancelBtn" type="button" class="btn btn-default form-control btn-xs" data-id="${clientUpdateInfo.clientId }" value="취소" />
								</div>
							</div>
					</form>
				</div>
