...
<c:set var="contextPath" value="${pageContext.request.contextPath}"></c:set>
		...
		<title>adminDailyReportList</title>
		...
		<span style="font-family: 'Poiret One',cursive;font-size: 50px;color: yellow; padding-bottom: 25px;">Daily Report List</span>
		<table id="grid"></table>
		<div  id="pager"></div>
		<p align="left">
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$Grid.jqGrid({
	          		url : '${contextPath}/admin/report/getDailyReportListJsonData',
	          		datatype : "json",
	          		jsonReader : {
	               		id : "dailyReportId", // 대표 아이디를 설정
	          		...
	          		colModel : [
	                    		...
	                    		{ name : 'dailyReportId',    hidden:true},
	                    		...
	                    		{ name : 'profit',  	  	  width:200,  align:'center', index:'c.profit', searchoptions:{sopt:['eq','ne','in','ni','ge','le','gt','lt']}},
					...
					beforeSelectRow: function (rowid, e) {
	          		...
	          		beforeProcessing : function(data){
	                	...
	                	$('#removeSelectedList').click(function(){
	                		...
	                		$.ajax({
								url:'${contextPath}/admin/report/deleteDailyReportList',
								data:{
									'ids':idList
								},
								type:'post',
	    		...
	    		//}).jqGrid('navGrid','#pager',{edit:false,add:false,del:false,search:true});
	 			...
	 			{
	 				var html = '<a style="color: blue;" href=/admin/report/viewDailyReport';
	 				html += '?employee.empId=' + rowdata.empId;
	 				html += '&dailyReportId=' + rowdata.dailyReportId;
	 				html += '&regDate=' + rowdata.regDate;
